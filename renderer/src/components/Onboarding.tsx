          ...
          <div className='min-h-[372px]'>
            <div className='pb-20 px-20 pt-16 min-h-[250px]'>
              <p className="text-body-s my-3">
                Station securely connects your computer to Filecoin&apos;s global peer-to-peer network, which rewards you for your participation. Once you&apos;ve connected, you will begin completing
                network jobs.
              </p>
            </div>
          ...
          <div className='min-h-[372px]'>
            <div className='pb-8 px-20 pt-8 min-h-[250px]'>
              <p className="text-body-s my-3">
                ...
                Your personal data will be processed and information from your device (cookies, unique identifiers, and other device data) may be stored by, accessed by and shared with third party
