// This code is shared between Electron main (backend) and GitHub Actions
// workflow
// We can use vanilla Node.js APIs only. In particular, we CANNOT use
// `require('electron)`
...
/**
 * @param {object} args
 * @param {string} args.version Semantic version number from package.json, e.g.
 *   `0.5.0`
 * @param {string | null} [args.buildTag] Git tag used to build this version.
 *   `undefined` for non-release builds.
 * @param {string | null} [args.buildNumber] CI build number of the workflow run
 ...
 *  - `x.y.z.1-dev` in all other cases (typically a local dev build), e.g.
 *    `0.5.0.1-dev`.
 */
